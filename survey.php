...
<html lang="en">
	...
	<body>
		<form class="survey-form" method="post" action="survey2.php">		
			...
			<div class="step-content current" data-step="1">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Reputasi Perguruan Tinggi"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="2">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Kesempatan Magang/Penempatan"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="3">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Biaya"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="4">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Keamanan Kampus"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="5">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Pendidikan dan Fasilitas Kampus"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="6">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Kegiatan Klub"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="7">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Lokasi Kampus"?</p>
					<div class="rating">
						<input type="radio" name="q7" id="radio25" value="1">
						<label for="radio25">1</label>
						<input type="radio" name="q7" id="radio26" value="2">
						<label for="radio26">2</label>
						<input type="radio" name="q7" id="radio27" value="3">
						<label for="radio27">3</label>
						<input type="radio" name="q7" id="radio28" value="4">
						<label for="radio28">4</label>
					</div>
					<div class="rating-footer">
						<span>Very Uncorrelated</span>
						<span>Very Correlated</span>
			...
			<div class="step-content" data-step="8">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Teman dan Keluarga"?</p>
					<div class="rating">
						<input type="radio" name="q8" id="radio29" value="1">
						<label for="radio29">1</label>
						<input type="radio" name="q8" id="radio30" value="2">
						<label for="radio30">2</label>
						<input type="radio" name="q8" id="radio31" value="3">
						<label for="radio31">3</label>
						<input type="radio" name="q8" id="radio32" value="4">
						<label for="radio32">4</label>
					</div>
					<div class="rating-footer">
						<span>Very Uncorrelated</span>
						<span>Very Correlated</span>
			...
			<div class="step-content" data-step="9">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Program yang Disediakan" dengan "Mentoring"?</p>
					<div class="rating">
						<input type="radio" name="q9" id="radio33" value="1">
						<label for="radio33">1</label>
						<input type="radio" name="q9" id="radio34" value="2">
						<label for="radio34">2</label>
						<input type="radio" name="q9" id="radio35" value="3">
						<label for="radio35">3</label>
						<input type="radio" name="q9" id="radio36" value="4">
						<label for="radio36">4</label>
					</div>
					<div class="rating-footer">
						<span>Very Uncorrelated</span>
						<span>Very Correlated</span>
		...
		<?php
	      if(isset($_POST['submit'])){
	        if(!empty($_POST['q1'])||!empty($_POST['q2'])||!empty($_POST['q3'])||!empty($_POST['q4'])||!empty($_POST['q5'])||!empty($_POST['q6'])||!empty($_POST['q7'])||!empty($_POST['q8'])||!empty($_POST['q9'])) {
	        	
	        	$data = ''.$_POST['q1'].','. $_POST['q2'].','.$_POST['q3'].','. $_POST['q4'].','. $_POST['q5'].','. $_POST['q6'].','. $_POST['q7'].','.$_POST['q8'].','.$_POST['q9'];
	        	print_r($data);
	        	file_put_contents("output.csv", print_r($data, true));
	        } else {
