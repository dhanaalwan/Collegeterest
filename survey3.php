...
<html lang="en">
	...
	<body>
		<form class="survey-form" method="post" action="survey4.php">		
			...
			<div class="step-content current" data-step="1">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kesempatan Magang/Penempatan" dengan "Biaya"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="2">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kesempatan Magang/Penempatan" dengan "Keamanan Kampus"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="3">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kesempatan Magang/Penempatan" dengan "Pendidikan dan Fasilitas Kampus"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="4">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kesempatan Magang/Penempatan" dengan "Kegiatan Klub"?</p>					
					<div class="rating">
			...
			<div class="step-content" data-step="5">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kesempatan Magang/Penempatan" dengan "Lokasi Kampus"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="6">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kesempatan Magang/Penempatan" dengan "Teman dan Keluarga"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="7">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kesempatan Magang/Penempatan" dengan "Mentoring"?</p>
					<div class="rating">
