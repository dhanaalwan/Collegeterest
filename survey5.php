...
<html lang="en">
	...
	<body>
		<form class="survey-form" method="post" action="survey6.php">		
			...
			<div class="step-content current" data-step="1">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Keamanan Kampus" dengan "Pendidikan dan Fasilitas Kampus"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="2">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Keamanan Kampus" dengan "Kegiatan Klub"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="3">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Keamanan Kampus" dengan "Lokasi Kampus"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="4">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Keamanan Kampus" dengan "Teman dan Keluarga"?</p>					
					<div class="rating">
			...
			<div class="step-content" data-step="5">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Keamanan Kampus" dengan "Mentoring"?</p>
					<div class="rating">
