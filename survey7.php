...
<html lang="en">
	...
	<body>
		<form class="survey-form" method="post" action="survey8.php">		
			...
			<div class="step-content current" data-step="1">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kegiatan Klub" dengan "Lokasi Kampus"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="2">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kegiatan Klub" dengan "Teman dan Keluarga"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="3">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Kegiatan Klub" dengan "Mentoring"?</p>
					<div class="rating">
