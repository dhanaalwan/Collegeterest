...
<html lang="en">
	...
	<body>
		<form class="survey-form" method="post" action="survey9.php">		
			...
			<div class="step-content current" data-step="1">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Lokasi Kampus" dengan "Teman dan Keluarga"?</p>
					<div class="rating">
			...
			<div class="step-content" data-step="2">
				<div class="fields">
					<p>Berapa besar tingkat keterkaitan faktor "Lokasi Kampus" dengan "Mentoring"?</p>
					<div class="rating">
		...
		<?php
	      if(isset($_POST['submit'])){
	        if(!empty($_POST['q1'])||!empty($_POST['q2'])) {
	        	...
	        	fwrite($myfile, $data);
	        	header("Location: http://localhost:8080/univfactor/survey9.php");
	        } else {
